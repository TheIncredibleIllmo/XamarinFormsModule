...
extern void *mono_aot_module_XamarinFormsModule_iOS_info;
...
extern void *mono_aot_module_XamarinFormsModule_info;
...
extern void *mono_aot_module_Unity_ServiceLocation_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_XamarinFormsModule_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_XamarinFormsModule_info);
	...
	mono_aot_register_module (mono_aot_module_Unity_ServiceLocation_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "XamarinFormsModule.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
